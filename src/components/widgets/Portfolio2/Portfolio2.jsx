      ...
      .map((item, index) => (
        ...
        >
          <div className={styles.item}>
            <img src={item.img || photo} alt="portfolio" />
  ...
  return (
    <Fragment>
      <div className={["layout-header", styles.header].join(" ")}>
        ...
        <h2>We are proud to show you some famous projects.</h2>
        <p>
        Our portfolio includes a wide range of projects, 
        including commercial buildings, residential homes, offices, and more. 
