  ...
  return (
    <Layout col="1" padding>
      <div className={["layout-header", styles.header].join(" ")}>
        ...
        <p>
         Take a look at our portfolio to see some of our recent projects.
         Our portfolio includes a wide range of projects, including commercial
         buildings, residential homes, offices, and more.
         We take great pride in our work and are committed to 
         delivering the highest quality construction projects.
        </p>
      </div>
      <div
